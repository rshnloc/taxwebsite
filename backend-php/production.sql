-- ============================================================
-- Helpshack — FULL PRODUCTION DATABASE
-- Generated: 2026-04-26
-- Run once on a fresh MySQL server:
--   mysql -u <USER> -p <DB_NAME> < production.sql
...
CREATE TABLE IF NOT EXISTS users (
  ...
  dynamic_role_id INT DEFAULT NULL,
...
-- Application documents (with password support)
CREATE TABLE IF NOT EXISTS application_documents (
  ...
  doc_password_enc VARCHAR(500) DEFAULT NULL,
  doc_password_hint VARCHAR(255) DEFAULT NULL,
...
INSERT IGNORE INTO users (name, email, password, role, is_active, is_verified) VALUES
  ('Super Admin', 'admin@helpshack.in', '$2y$12$ef9hu2zyq96K8zkahcd6DOQhlqdxIjg3LOoZkO2el/8U/fZaMmpl6', 'admin', 1, 1);
